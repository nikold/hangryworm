...
public class Game2Screen implements Screen {
    ...
    public void render(float delta) {
        ...
        DrawHead();
        DrawElements();
        //создать массив из прямоугольников. динамически пересчитывать координаты звеньев
        //каждое звено знает о впереди стоящщем через ссылку
        //каждое звено получает координаты впереди стоящего в рендере
        ...
        //Голова в квадрате еды. Убираем квадрат еды. Статус foodEated = true
        //Если foodEated = true и голова не в квадрате еды, то создаем на месте еды квадрат elem и добавляем в массив
        //Голова меняет координату, элемент принимает координаты предыдущего положения головы
